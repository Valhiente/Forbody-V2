...
export const unitsData: Unit[] = [
  {
    ...
    galleryUrls: [
      { category: 'academia', title: 'Academia Ribeirão Preto', imageUrl: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
      { category: 'equipamentos', title: 'Equipamentos Ribeirão Preto', imageUrl: 'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
    ],
    teachers: [
  ...
  },
  {
    ...
    businessHours: defaultBusinessHours,
    galleryUrls: [
      { category: 'academia', title: 'Academia Franca', imageUrl: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
    ],
    teachers: [],
  },
  {
    ...
    businessHours: defaultBusinessHours,
    galleryUrls: [
      { category: 'academia', title: 'Academia Barretos', imageUrl: 'https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
    ],
    teachers: [],
  }
];
