...
export const unitsData: Unit[] = [
  ...
  {
    id: 'u-barao', slug: 'barao-do-bananal', name: 'Barão do Bananal', city: 'Ribeirão Preto', state: 'SP', evoId: 2, evoUnitId: 2, salesUrl: '#', studentAreaUrl: '#', locationUrl: 'https://www.google.com/maps/search/?api=1&query=Forbody&query_place_id=ChIJwVOXprm_uZQREFsgGHIf8y4', status: 'active', googleReviewsScore: 4.6, googleReviewsCount: 30, address: 'Av. Barão do Bananal, 820 - Chácara São João, Ribeirão Preto - SP', whatsapp: '5516997122560', imageUrl: '/images/units/barao-do-bananal.jpg', instagram: '@forbody.barao', mapEmbedUrl: '', businessHours: defaultBusinessHours,
    googleReviews: [
  ...
  {
    id: 'u-vila-virginia', slug: 'vila-virginia', name: 'Vila Virgínia', city: 'Ribeirão Preto', state: 'SP', evoId: 3, evoUnitId: 3, salesUrl: '#', studentAreaUrl: '#', locationUrl: 'https://www.google.com/maps/search/?api=1&query=Forbody&query_place_id=ChIJjx8pfwC_uZQRt8MeuNMo8aA', status: 'active', googleReviewsScore: 4.5, googleReviewsCount: 25, address: 'R. Franco da Rocha, 1370 - Vila Virginia, Ribeirão Preto - SP', whatsapp: '5516992238286', imageUrl: '/images/units/vila-virginia.jpg', instagram: '@forbody.vilavirg', mapEmbedUrl: '', businessHours: defaultBusinessHours,
    googleReviews: [
  ...
  {
    id: 'u-portinari', slug: 'portinari', name: 'Portinari', city: 'Ribeirão Preto', state: 'SP', evoId: 4, evoUnitId: 4, salesUrl: '#', studentAreaUrl: '#', locationUrl: 'https://www.google.com/maps/search/?api=1&query=Forbody&query_place_id=ChIJNegEDqjBuZQRsXJxQT9NpTo', status: 'active', googleReviewsScore: 4.4, googleReviewsCount: 18, address: 'Av. Nelson Ferreira De Melo, 365 - Candido Portinari, Ribeirão Preto - SP', whatsapp: '5516997102560', imageUrl: '/images/units/portinari.jpg', instagram: '@forbody.portinari', mapEmbedUrl: '', businessHours: defaultBusinessHours,
    googleReviews: [
