    ...
    <div className="space-y-2">
      ...
      {textarea ? (
        <textarea
          ...
          className="min-h-[120px] w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-sm text-white outline-none"
        />
      ) : (
        <input
          name={name}
          placeholder={placeholder}
          className="h-12 w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 text-sm text-white outline-none"
        />
      )}
    </div>
  );
...
export default function MarketingPage() {
  return (
    <div className="min-h-screen bg-black p-6">
      <form action={updateMarketingManagerAction} className="mx-auto max-w-5xl space-y-8">
        <div className="space-y-2">
        ...
        <Section title="Frases da Home">
          ...
          <Input label="Descrição da seção de planos" name="plansDescription" textarea />
        ...
        <Section title="Promoções">
          ...
          <label className="flex items-center gap-3 text-sm text-white">
            <input type="checkbox" name="promoActive" className="h-4 w-4" />
            Ativar/desativar
          </label>
        </Section>
        ...
        <div className="sticky bottom-0 border border-zinc-800 bg-black/95 p-4 backdrop-blur rounded-2xl">
          <button
            type="submit"
